...
The Runtime Menu and Control Center use the same gear for Settings, eye for AVISO Groups, and slider-control symbol for display Modes. The Control Center uses a monitor symbol for its Display page.
