...
- Unified Runtime Menu and Control Center navigation symbols: Settings uses shared slider controls, Groups uses an eye, Modes uses layered views, Insets uses a monitor, and the Control Center Display page uses an aircraft.
