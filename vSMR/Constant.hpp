...
const int DRAWING_TAGDEF_EDITOR = 1290;
...
const int RIMCAS_PROFILE_COLOR_SELECT = 8036;
const int RIMCAS_PROFILE_COLOR_PICKER = 8039;
const int RIMCAS_PROFILE_COLOR_EDIT_RGB = 8040;
const int RIMCAS_PROFILE_COLOR_EDIT_ALPHA = 8041;
const int RIMCAS_PROFILE_COLOR_EDIT_HEX = 8061;
const int RIMCAS_TAGDEF_SELECT_TYPE = 8042;
const int RIMCAS_TAGDEF_SELECT_MODE = 8043;
const int RIMCAS_TAGDEF_INSERT_TOKEN = 8044;
const int RIMCAS_TAGDEF_INSERT_TOKEN_BOLD = 8064;
const int RIMCAS_TAGDEF_SELECT_STATUS = 8045;
...
const int RIMCAS_TAGDEF_EDIT_LINE_BASE = 8050;
