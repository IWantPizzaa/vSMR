...
public:
	...
	bool ShowProfileColorPicker = false;
	bool ProfileColorPickerHasAlpha = false;
	double ProfileColorPickerHue = 0.0;
	double ProfileColorPickerSaturation = 0.0;
	double ProfileColorPickerValue = 1.0;
	int ProfileColorPickerAlpha = 255;
	bool ProfileColorPickerDragWheel = false;
	bool ProfileColorPickerDragValue = false;
	bool ProfileColorPickerDragAlpha = false;
	bool ProfileColorPickerDirty = false;
	CRect ProfileColorPickerPanelRect;
	CRect ProfileColorPickerWheelRect;
	CRect ProfileColorPickerValueRect;
	CRect ProfileColorPickerAlphaRect;
	CRect ProfileColorPickerCloseRect;
	CRect ProfileColorPickerSelectRect;
	CRect ProfileColorPickerPreviewRect;
	CRect ProfileColorPickerRgbTextRect;
	CRect ProfileColorPickerAlphaTextRect;
	CRect ProfileColorPickerHexTextRect;
	...
	CRect TagDefinitionEditorPanelRect;
	CRect TagDefinitionEditorCloseRect;
	CRect TagDefinitionEditorTypeRect;
	CRect TagDefinitionEditorModeRect;
	CRect TagDefinitionEditorStatusRect;
	CRect TagDefinitionEditorTargetColorRect;
	CRect TagDefinitionEditorLabelColorRect;
	CRect TagDefinitionEditorPreviewRect;
	CRect TagDefinitionEditorTokenButtonRect;
	CRect TagDefinitionEditorBoldTokenButtonRect;
	CRect TagDefinitionEditorTokenListRect;
	std::array<CRect, TagDefinitionEditorMaxLines> TagDefinitionEditorLineRects;
	...
	void OpenProfileColorPicker(const std::string& path, bool keepTagDefinitionEditorOpen = false);
