...
const int RIMCAS_ACTIVE_PROFILE = 7998;
const int RIMCAS_ACTIVE_AIRPORT = 7999;
const int RIMCAS_ACTIVE_AIRPORT_FUNC = 8008;
const int RIMCAS_ACTIVE_PROFILE_FUNC = 8009;
...
const int RIMCAS_ALERTS_TOGGLE_FUNC = 8021;
...
const int RIMCAS_UPDATE_ICON_STYLE = 8046;
const int RIMCAS_TOGGLE_SMALL_ICON_BOOST = 8047;
const int RIMCAS_UPDATE_SMALL_ICON_BOOST_FACTOR = 8048;
const int RIMCAS_UPDATE_SMALL_ICON_BOOST_RESOLUTION = 8049;
const int RIMCAS_TOGGLE_FIXED_PIXEL_ICON_SIZE = 8062;
const int RIMCAS_UPDATE_FIXED_PIXEL_TRIANGLE_SCALE = 8063;
const int RIMCAS_UPDATE_DISPLAY_MODE = 8064;
const int RIMCAS_UPDATE_TAG_FONT = 8060;
const int RIMCAS_AVISO_PRESET_LOAD = 8070;
const int RIMCAS_AVISO_PRESET_CREATE_PROMPT = 8071;
const int RIMCAS_AVISO_PRESET_CREATE = 8072;
const int RIMCAS_AVISO_PRESET_UPDATE = 8073;
const int RIMCAS_AVISO_PRESET_RENAME_PROMPT = 8074;
const int RIMCAS_AVISO_PRESET_RENAME = 8075;
const int RIMCAS_AVISO_PRESET_DUPLICATE_PROMPT = 8076;
const int RIMCAS_AVISO_PRESET_DUPLICATE = 8077;
const int RIMCAS_AVISO_PRESET_DELETE = 8078;
const int RIMCAS_AVISO_PRESET_SET_DEFAULT = 8079;
const int RIMCAS_AVISO_PRESET_CLEAR_DEFAULT = 8080;
const int RIMCAS_AVISO_PRESET_RESET = 8081;
const int RIMCAS_AVISO_PRESET_TOGGLE_LINK = 8082;
const int RIMCAS_AVISO_EDITOR_OPEN = 8083;
const int RIMCAS_AVISO_RELOAD = 8084;
...
const int RIMCAS_UPDATERANGE3 = 6008;
...
const int RIMCAS_UPDATEROTATE3 = 6028;
