...
| AVISO airport geometry | `AVISO/AVISO_*.geojson` | Derived from project-maintained airport display data; source and contributor attribution are not recorded per airport | Verification required |
