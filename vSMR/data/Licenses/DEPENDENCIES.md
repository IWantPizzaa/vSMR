...
this directory. It describes the dependencies used by vSMR 2.0.0-beta.1 so a
...
| --- | --- | --- | --- | --- |
| vSMR | 2.0.0-beta.1 | EuroScope plugin and bundled UI/data | `vSMR.dll`, `vSMR_Data` | `vSMR.txt` (GPL-3.0) |
...
| Microsoft Visual C++ and MFC runtimes | Visual Studio 2022 / v143 | Native runtime | Not bundled; x86 redistributable required | Microsoft redistributable terms |
