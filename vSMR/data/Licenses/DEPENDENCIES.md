...
this directory. It describes the dependencies used by vSMR 2.0.0-beta.3 so a
...
| --- | --- | --- | --- | --- |
| vSMR | 2.0.0-beta.3 | EuroScope plugin and bundled UI/data | `vSMR.dll`, `vSMR_Data` | `vSMR.txt` (GPL-3.0) |
